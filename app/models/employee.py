...
class Employee(db.Model):
    ...
    reporting_manager_id = db.Column(db.UUID(as_uuid=True), db.ForeignKey('employees.id'), nullable=True)
    bank_partners = db.Column(db.JSON, default=[])  # List of assigned banks
